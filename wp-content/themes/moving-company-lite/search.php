...
<div class="container">
    <main id="maincontent" role="main" class="middle-align">
        <?php
            $theme_lay = get_theme_mod( 'moving_company_lite_theme_options','Right Sidebar');
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','moving-company-lite'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
