...
if ( ! class_exists( 'Moving_Company_Lite_Content_Creation' ) ) :

	/**
	 * Moving_Company_Lite_Content_Creation class.
	 */
	class Moving_Company_Lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * Moving_Company_Lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Moving_Company_Lite_Content_Creation' );
